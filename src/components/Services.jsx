...
const Services = () => {
    return (
        <div className='flex flex-col items-center mt-5 m-2 p-2'>
            <h1 className='text-xl font-semibold  dark:text-white'>Our <span className='text-[#1A8500]'>Services</span></h1>

            {/* Farmers Section */}
            <div className='flex flex-col md:flex-row border-[#E9E9E9] dark:border-[#464545] border-2 rounded-md justify-between my-4 '>
                <img src={farmers} alt="Farmers" className='object-cover w-full md:w-1/4 h-auto' />
                <div className='w-full md:w-[65%] my-2 mx-5'>
                    <h5 className='font-semibold  dark:text-white my-1'>Our farmers</h5>
                    <p className='text-[#363636] font-medium text-base my-4 dark:text-[#E9E9E9]'>
            ...
            {/* Customers Section */}
            <div className='flex flex-col md:flex-row-reverse border-[#E9E9E9] dark:border-[#464545] border-2 rounded-md justify-between my-4 '>
                <img src={customers} alt="We take care of our customers" className='object-cover w-full md:w-1/4 h-auto' />
                <div className='w-full md:w-[65%] my-2 mx-5'>
                    <h5 className='font-semibold  dark:text-white my-1'>Our customers</h5>
                    <p className='text-[#363636] font-medium text-base my-4  dark:text-[#E9E9E9]'>
            ...
            <div className='flex flex-col md:flex-row border-[#E9E9E9] dark:border-[#464545] border-2 rounded-md justify-between my-4  '>
                ...
                <div className='w-full md:w-[65%] my-2 mx-5'>
                    <h5 className='font-semibold  dark:text-white my-1'>Transportation</h5>
                    <h5 className='font-semibold  dark:text-white my-2'>Linking lives, connecting destinations</h5>
                    <p className='text-[#363636] font-medium text-base my-4  dark:text-[#E9E9E9]'>
                        FOSEC provides consumers with transparency and trust in the food supply chain. Our cryptographic seals let you trace the journey of your food, ensuring it’s safe, sustainable, and ethically sourced. Every purchase you make supports farmers who are committed to sustainable agriculture.
                    </p>
                    <p className='text-[#363636] font-medium text-base my-4  dark:text-[#E9E9E9]'>
