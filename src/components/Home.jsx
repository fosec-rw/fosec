    ...
    <div className="flex flex-col md:flex-row justify-center items-center m-2 p-2">
      ...
      <div className="flex flex-col w-full md:w-[58%]">
        ...
        <p className="text-[#363636] font-medium my-6  dark:text-[#E9E9E9]">
          At FOSEC, we believe in transforming agriculture through the power of
          technology. Our platform provides farmers with the tools they need to
          improve yields, make smarter decisions, and secure their supply
          chains. Whether you're a farmer looking for real-time advice or a
          customer seeking transparency in the food you consume, FOSEC is here
          to make a difference. Together, we’re creating a sustainable future
