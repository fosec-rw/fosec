    ...
    <nav className="p-4 border-[#6FFF63] border-x-0 border-t-0 border">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-8">
          <a href="#home" className="text-[#4E4E4E] hover:text-gray-400">Home</a>
          <a href="#services" className="text-[#4E4E4E] hover:text-gray-400">Services</a>
          <a href="#features" className="text-[#4E4E4E] hover:text-gray-400">Features</a>
          <a href="#contact" className="text-[#4E4E4E] hover:text-gray-400">Contact Us</a>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden mt-2 space-y-2">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <button className="text-black border border-black px-3 py-1 rounded-lg">Sign In</button>
          </div>
        </div>
      )}
    </nav>
